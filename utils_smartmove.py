...
#def calc_mod_density_kagari(mass_kg, dens_kgm3, n_blocks, block_type):
...
def add_bodydensity_to_experiments(path_field, path_isotope):
    ...
    for i in range(len(field)):
        ...
        total_dens = calc_mod_density(field['mass_kg'][i],
